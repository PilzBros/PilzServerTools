...
public class Update {
    ...
    public Update(int projectID, PilzServerTools pst) {
        this(projectID, (String)null, pst);
    }

    public Update(int projectID, String apiKey, PilzServerTools pst) {
    ...
    public void query() {
        ...
        try {
            ...
            if (array.size() > 0) {
                ...
                if (Double.parseDouble(versionName) > Double.parseDouble("2.3")) {
                    ...
                    System.out.println("");
                    this.pst.updateNeeded = true;
                } else {
                    System.out.println("[PilzServerTools] You're running the latest version!");
                }
            } else {
